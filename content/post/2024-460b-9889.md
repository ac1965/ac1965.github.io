...
lastmod = 2024-05-12T17:32:26+09:00
...
homebrewのglibcは
/usr/local/Cellar/glib/2.80.0_2/lib/libglib-2.0.0.dylib
みたいなんだけど。
...
[^fn:1]: Emacsのエディタ機能は大量のLispで作られているので実行する都度読んで解釈していたLispコードを、ネイティブコードつまりバイナリコードにバックグラウンドで自動的にコンパイルする機能で、次回から最速で動作することが期待される。
