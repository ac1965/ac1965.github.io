...
-   [Cuckoo](http://www.cuckoosandbox.org)で簡易マルウェア自動解析をしてみたい
-   [ゲストOSの準備](http://cuckoo.readthedocs.org/en/latest/installation/guest/)としては、あらかじめ [ModernIE](https://www.modern.ie/ja-jp) から Linux 版の Virtualbox イメージをダウンロードしておき、[Python](https://www.python.org/getit/) と [PIL(Python Image Library)](http://www.pythonware.com/products/pil/) をインストールしておく。cuckoo の agent.py は起動時に自動実行できるよう agent.pyw にリネームしておく。
