...
[Ollamaで利用可能なモデル](https://ollama.com/library) も豊富で、せっせとアップしてくれる文化があったので、Emacs で動くパッケージもあるだろうと、最近お気に入りの [Perplexity](https://www.perplexity.ai) で調べた。[Google](https://www.google.com) でもいいだけど、サッと調べてくれるから。
