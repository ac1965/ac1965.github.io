...
[backtrack4のフォーラム](http://www.backtrack-linux.org/forums/)を読んでいたら、質問だけして自分では調べようとしない人を見かけたのでフォローしておいた。内容は distro の iso を更新する方法についてだったのだけど、[bt4-customise.sh](http://www.offensive-security.com/blog/backtrack/customising-backtrack-live-cd-the-easy-way/)を使えばできるとのこと。
