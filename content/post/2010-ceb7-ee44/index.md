...
lastmod = 2026-09-25T22:15:15+09:00
...
クロスコンパイル環境やルートファイルシステムまわりの作業メモ。[GuruPlug Wiki](http://www.plugcomputer.org/plugwiki/index.php/GuruPlug%22) に自分なりの補足を加えたものも含んでいる。
...
クロスコンパイルは [GNU Hurd](http://www.gnu.org/software/hurd/) で遊んで以来ずっと触っていなかったけれど、Gentoo だとかなり楽にできる。
...
### cpioのコンパイルエラーは stat(2) の引数が指定されていなかっただけだった {#cpioのコンパイルエラーはstat2-の引数が指定されていなかっただけだった}
